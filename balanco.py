...
class Balanco():
    ...
    def __init__(self) -> None:
        ...
        self.cordaD = ((0.05,0.5,8.2),(0.05,0.5,0.23),(0.05,0.6,0.23),(0.05,0.6,8.2),(-0.05,0.5,8.2),(-0.05,0.6,0.23),(-0.05,0.6,8.2),(-0.05,0.5,0.23))
        self.cordaE = ((0.05,-0.5,8.2),(0.05,-0.5,0.23),(0.05,-0.6,0.23),(0.05,-0.6,8.2),(-0.05,-0.5,8.2),(-0.05,-0.6,0.23),(-0.05,-0.6,8.2),(-0.05,-0.5,0.23))
