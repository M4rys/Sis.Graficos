...
class Cadeira():
    ...
    def cria_cadeira(self, prop, pos) :
        ...
        self.mostra_mesa(new_partes[0], new_partes[1], new_partes[2], new_partes[3], new_partes[4], new_partes[5], new_partes[6], new_partes[7], new_partes[8], new_partes[9], new_partes[10], new_partes[11])
    
    def mostra_mesa(self, tampa, suporte1, suporte2, peE1, peD1, peE2, pD2, costa,jpTA, jpTB, jpFA, jpFB):
        ...
        solidCube(self.cuboFaces, costa)
        solidCube(self.cuboFaces, jpTA)
        solidCube(self.cuboFaces, jpTB)
        solidCube(self.cuboFaces, jpFA)
        solidCube(self.cuboFaces, jpFB)
